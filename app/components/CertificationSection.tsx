...
const certificates = [
  {
    ...
    image: 'postman.jpg', // Ensure this image is in your public folder
...
export default function CertificationSection() {
  ...
  return (
    // Changed ID to "certificates" (plural) to match the Header link
    <section id="certificates" className="py-8 md:py-20 px-6 relative bg-black/20" ref={ref}>
      <div className="max-w-7xl mx-auto">
        ...
        >
          {/* Removed font-['Roboto'], now inherits global fonts */}
              ...
              <div className="p-6 relative z-20 -mt-10">
                <div className="bg-[#0a0b1a] p-4 rounded-lg border border-gray-800 group-hover:border-[#D8ECF8]/20 transition-colors">
                  <div className="flex justify-between items-start mb-2">
                    <span className="text-xs text-[#D8ECF8] bg-[#D8ECF8]/10 px-2 py-1 rounded">
                      {cert.date}
                    </span>
                    <i className="ri-award-line text-gray-400 group-hover:text-[#D8ECF8] transition-colors"></i>
                  </div>
                  <h3 className="text-xl font-bold text-white mb-1 group-hover:text-[#D8ECF8] transition-colors">
                    {cert.title}
                  </h3>
