    ...
    <section id="about" className="bg-black text-gray-300 py-10 md:py-28">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-20">
          ...
          >
            I'M ANUSHKA SHARMA, a learning developer from India. I love building interactive, visually engaging websites that merge creativity with functionality. I’m working on real-world projects while honing my skills, passionate about exploring AI and cloud computing to build innovative and scalable solutions. Beyond coding, I’m always exploring new technologies, pushing creative boundaries, and experimenting with design to bring fresh ideas to life.
          </motion.h1>
        </div>
